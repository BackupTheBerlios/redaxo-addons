  ...
  if($send == 0){ // ---> Ausgabe des Formulars
    ...
    echo "
      ...
      <tr>
        ...
        <td class=grey><input type=text name=article[artnr] value=\"".htmlspecialchars($act_art->getArticleNumber())."\" class=inp100 /></td>
      </tr>
      <tr>
        <td class=grey>&nbsp;</td>
        <td class=grey>".$I18N_SIMPLE_SHOP->msg("product_name")."</td>
        <td class=grey><input type=text name=article[name] value=\"".htmlspecialchars($act_art->getName())."\" class=inp100 /></td>
      </tr>
      ...
      <tr>
        ...
        <td class=grey><textarea name='article[desc]' style='width:100%;height:70px;'>".htmlspecialchars($act_art->getDescription())."</textarea></td>
      </tr>
      ...
      <tr>
        ...
        <td class=grey><input type=text name=article[price] value=\"".htmlspecialchars($act_art->getPrice())."\" class=inp100 /></td>
      </tr>
      <tr>
        <td class=grey>&nbsp;</td>
        <td class=grey>".$I18N_SIMPLE_SHOP->msg("product_price_old")."</td>
        <td class=grey><input type=text name=article[oldprice] value=\"".htmlspecialchars($act_art->getOldPrice())."\" class=inp100 /></td>
      </tr>
      <tr>
        <td class=grey>&nbsp;</td>
        <td class=grey>".$I18N_SIMPLE_SHOP->msg("product_price_order")."</td>
        <td class=grey><input type=text name=article[deliverprice] value=\"".htmlspecialchars($act_art->getDeliverPrice())."\" class=inp100 /></td>
      </tr>
      <tr>
        <td class=grey>&nbsp;</td>
        <td class=grey>".$I18N_SIMPLE_SHOP->msg("product_tax")."</td>
        <td class=grey><input type=text name=article[tax] value=\"".htmlspecialchars($act_art->getTax())."\" class=inp100 /></td>
      </tr>
    ...
    echo "
      ...
      <tr>
        ...
        <td class=grey><input type=text name=article[stockinfo] value=\"".htmlspecialchars($act_art->getStockinfo())."\" class=inp100 /></td>
      </tr>
      <!--
      <tr>
        <td class=grey>&nbsp;</td>
