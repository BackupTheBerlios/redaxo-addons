 ...
 * @package redaxo3
 * @version $Id: config.inc.php,v 1.7 2007/09/09 12:01:34 kills Exp $
 */
...
{
  return $params['subject'] .'  <link rel="stylesheet" type="text/css" href="../files/addon_framework/common.css" />'. "\n";
}
