...
class browseBar extends rexListToolbar
{
  ...
  function show()
  {
    ...
    $add = $this->getAddButtonStatus() ? $this->link('<img src="media/add.gif" width="24" height="13" title="Neuen Eintrag hinzufügen" alt="Neuen Eintrag hinzufügen" />', $this->add_params) : '';
    $next = $this->link('<img src="media/forward.gif" width="24" height="13" title="Zur nächsten Seite" alt="Zur nächsten Seite" />', array ('next' => $steps['next']));
