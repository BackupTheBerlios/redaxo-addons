 ...
 * @package redaxo3
 * @version $Id: field.wysiwygDateField.inc.php,v 1.2 2007/02/01 19:43:51 kills Exp $
 */
...
class wysiwygDateField extends readOnlyTextField
{
  ...
  function wysiwygDateField($name, $label, $attributes = array (), $id = '')
  {
  	...
  	if($first)
  	{
  		...
  		echo '<script language="javascript" type="text/javascript" src="../files/calendar/calendar_stripped.js"></script>';
