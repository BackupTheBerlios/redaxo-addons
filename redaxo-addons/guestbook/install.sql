...
INSERT INTO `%TABLE_PREFIX%module` (`id`, `label`, `name`, `category_id`, `ausgabe`, `bausgabe`, `eingabe`, `func`, `php_enable`, `html_enable`, `perm_category`, `createuser`, `updateuser`, `createdate`, `updatedate`) 
