...
require $QUIXPATH.".config/conf.php";
if(isset($GLOBALS["lang"])) $GLOBALS["language"]=$GLOBALS["lang"];
require $QUIXPATH."_lang/".$GLOBALS["language"].".php";
require $QUIXPATH."_lang/".$GLOBALS["language"]."_mimes.php";
require $QUIXPATH.".config/mimes.php";
require $QUIXPATH.".include/fun_extra.php";
require $QUIXPATH.".include/header.php";
require $QUIXPATH.".include/footer.php";
require $QUIXPATH.".include/error.php";
ob_end_clean(); // get rid of cached unwanted output
//------------------------------------------------------------------------------
if($GLOBALS["require_login"]) {	// LOGIN
	ob_start(); // prevent unwanted output
	require $QUIXPATH.".include/login.php";
	ob_end_clean(); // get rid of cached unwanted output
